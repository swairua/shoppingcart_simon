    ...
    <div class="container product_section_container" style="padding: 30px;">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3>Order(s) - (Folio Number-{{$orders->id}})</h3>
                <table class="table table-bordererd table-hover">
                    <tr>
                        <th>Image</th>
                        <th>Product Name</th>
                    ...
                    @foreach($orders->baskets->basket_products as $basket_product)
                        <tr>
                            ...
                            <td>{{number_format($basket_product->price,2)}} Kes</td>
                            <td>{{ $basket_product->quantity }}</td>
                            <td>{{number_format($basket_product->price * $basket_product->quantity,2)}} Kes</td>
                            <td>{{ $orders->status }}</td>
                        </tr>
                    @endforeach
                    <tr>
                        <th colspan="4" class="text-right">Total Price (VAT included)</th>
                        <td colspan="2">{{number_format(($basket_product->price * $basket_product->quantity) * 1.16,2)}} Kes</td>
                    </tr>
                    <tr>
