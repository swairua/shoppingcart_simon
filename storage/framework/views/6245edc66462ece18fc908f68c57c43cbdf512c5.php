        ...
        <div class="row">
            ...
            <div class="col-lg-5">
                <div class="product_details">
                    ...
                    <!--div class="original_price"><?php echo e(number_format($product->original_price)); ?> Kes</div-->
                    ...
                    <hr>
                        ...
                        <div class="checkout">
                            ...
                            <a href="<?php echo e(route('basket')); ?>" class="btn btn-primary">view cart</a>
                                    <!--i class="fa fa-shopping-cart" aria-hidden="true"></i-->
                                <span id="checkout_items" class="checkout_items"><?php echo e(Cart::count()); ?>
