...
<html lang="en">
<head>
    <title>Shopping Cart - <?php echo e(config('app.name')); ?> </title>
    <meta charset="utf-8">
    ...
    <header class="header trans_300">
        ...
        <div class="top_nav">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="top_nav_left">Laravel Shopping Cart</div>
                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer_nav_container">
                        <div class="cr" style="float:right">©2018 Laravel Class_Simon</a></div>
                    </div>
                </div>
            </div>
        </div>
